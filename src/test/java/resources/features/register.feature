Feature: Register feature
  ...
  Scenario: User should create account successfully
    ...
    And I enter first name "Vikas"
    And I enter last name "Lodha"
    And I select day
    And I select month
    And I select Year
    And I enter emailId "vikashlodha@gmail.com"
    And I enter password "vikas13658" in password field
    And I confirm password "vikas13658"
    And I click on register button
